...
def main():
    ...
    parser.add_argument("--prompt", type=str, default="a proverb related to the japanese says: no one who can rise before dawn three hundred", help="prompt for generation")
